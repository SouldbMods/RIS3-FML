...
public class RocketPlateItem extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:rocket_plate")
	public static final Item block = null;
	public RocketPlateItem(Ris3ModElements instance) {
		super(instance, 112);
	}
