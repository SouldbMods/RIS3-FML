...
@OnlyIn(Dist.CLIENT)
public class AluminumShaperGuiWindow extends ContainerScreen<AluminumShaperGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = AluminumShaperGui.guistate;
	public AluminumShaperGuiWindow(AluminumShaperGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ris3:textures/aluminum_shaper.png");
	@Override
