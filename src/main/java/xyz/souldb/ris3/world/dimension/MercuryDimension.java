...
public class MercuryDimension extends Ris3ModElements.ModElement {
	public MercuryDimension(Ris3ModElements instance) {
		super(instance, 244);
	}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(HardStoneBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("ris3:mercury"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
