...
public class GotoplanetsguiProcedure extends Ris3ModElements.ModElement {
	public GotoplanetsguiProcedure(Ris3ModElements instance) {
		super(instance, 108);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				Ris3Mod.LOGGER.warn("Failed to load dependency y for procedure Gotoplanetsgui!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				Ris3Mod.LOGGER.warn("Failed to load dependency z for procedure Gotoplanetsgui!");
			return;
		}
