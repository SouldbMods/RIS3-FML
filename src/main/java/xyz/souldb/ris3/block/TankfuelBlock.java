...
import xyz.souldb.ris3.gui.FuelTankUIGui;
...
public class TankfuelBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:tankfuel")
	public static final Block block = null;
	@ObjectHolder("ris3:tankfuel")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TankfuelBlock(Ris3ModElements instance) {
		super(instance, 181);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tankfuel"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tankfuel");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new FuelTankUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
