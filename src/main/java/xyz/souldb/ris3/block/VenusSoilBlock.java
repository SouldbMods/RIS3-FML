...
public class VenusSoilBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:venus_soil")
	public static final Block block = null;
	public VenusSoilBlock(Ris3ModElements instance) {
		super(instance, 213);
	}
