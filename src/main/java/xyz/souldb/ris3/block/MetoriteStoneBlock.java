...
public class MetoriteStoneBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:metorite_stone")
	public static final Block block = null;
	public MetoriteStoneBlock(Ris3ModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metorite_stone");
		}
