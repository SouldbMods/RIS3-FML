...
public class KryptonyteBlockBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:kryptonyte_block")
	public static final Block block = null;
	public KryptonyteBlockBlock(Ris3ModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("kryptonyte_block");
		}
