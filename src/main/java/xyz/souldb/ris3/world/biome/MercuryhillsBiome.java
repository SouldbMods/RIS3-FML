...
import xyz.souldb.ris3.block.HardStoneBlock;
...
public class MercuryhillsBiome extends Ris3ModElements.ModElement {
	public static Biome biome;
	public MercuryhillsBiome(Ris3ModElements instance) {
		super(instance, 245);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(HardStoneBlock.block.getDefaultState(),
								HardStoneBlock.block.getDefaultState(), HardStoneBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("ris3:mercuryhills"));
			}
		}
	}
	@Override
