...
public class PlanetSelectScreenClassGui extends Ris3ModElements.ModElement {
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PlanetSelectScreenClassGuiWindow::new));
	}
		...
		if (buttonID == 4) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				GoToMarsSelectScreenProcedure.executeProcedure($_dependencies);
			}
		}
	}
