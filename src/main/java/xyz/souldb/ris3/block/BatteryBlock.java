...
import xyz.souldb.ris3.itemgroup.RisenergyItemGroup;
...
public class BatteryBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:battery")
	public static final Block block = null;
	@ObjectHolder("ris3:battery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryBlock(Ris3ModElements instance) {
		super(instance, 255);
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(RisenergyItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(60000, 128, 128, 0) {
			@Override
