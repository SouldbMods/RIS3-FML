...
import xyz.souldb.ris3.item.AluminiumIngotItem;
...
public class AluminiumOreBlock extends Ris3ModElements.ModElement {
	@ObjectHolder("ris3:aluminium_ore")
	public static final Block block = null;
	public AluminiumOreBlock(Ris3ModElements instance) {
		super(instance, 123);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ris3:aluminium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ris3:aluminium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
