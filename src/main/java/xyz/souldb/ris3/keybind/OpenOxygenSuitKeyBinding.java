...
public class OpenOxygenSuitKeyBinding extends Ris3ModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public OpenOxygenSuitKeyBinding(Ris3ModElements instance) {
		super(instance, 166);
	...
	public void initElements() {
		keys = new KeyBinding("key.ris3.open_oxygen_suit", GLFW.GLFW_KEY_Y, "key.categories.misc");
