...
public class VenusBiome extends Ris3ModElements.ModElement {
	public static Biome biome;
	public VenusBiome(Ris3ModElements instance) {
		super(instance, 214);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ris3:venus"));
			}
		}
	}
	@Override
